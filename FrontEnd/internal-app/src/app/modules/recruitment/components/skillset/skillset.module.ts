...
import { TableFooterComponent } from 'src/app/modules/shared/components/table-footer/table-footer.component';
...
import { TableSearchComponent } from 'src/app/modules/shared/components/table-search/table-search.component';
